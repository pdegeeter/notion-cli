...
async fn test_run_db_get() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Database(DatabaseCommands::Get { id: "db-1".into() }),
        &client,
        None,
        None,
        &OutputFormat::Raw,
...
async fn test_run_ds_get() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Datasource(DatasourceCommands::Get { id: "ds-1".into() }),
        &client,
        None,
        None,
        &OutputFormat::Raw,
...
async fn test_run_ds_create() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Datasource(DatasourceCommands::Create {
            parent: "page-1".into(),
            title: "My DS".into(),
            properties: None,
        }),
...
async fn test_run_ds_update() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Datasource(DatasourceCommands::Update {
            id: "ds-1".into(),
...
async fn test_run_ds_query() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Datasource(DatasourceCommands::Query {
            id: "ds-1".into(),
            filter: None,
            sorts: None,
        }),
...
async fn test_run_ds_templates() {
    ...
    let client = NotionClient::with_base_url("token", &server.url()).unwrap();
    let result = run_with_client(
        Commands::Datasource(DatasourceCommands::Templates { id: "ds-1".into() }),
        &client,
        None,
        None,
        &OutputFormat::Raw,
